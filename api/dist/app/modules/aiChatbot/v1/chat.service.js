...
const chatBotService = (message, user, inboxId) => __awaiter(void 0, void 0, void 0, function* () {
    // chek inbox id
    const inbox = yield chat_model_1.default.findById(inboxId);
    if (!inbox) {
        // check if user exist or not
        const isUserExists = yield user_model_1.default.isUserExsitsByUserEmail(user.email);
        if (!isUserExists) {
    ...
    const result = yield (0, intentRouter_services_1.intentRouter)(jobs, message, user.email);
    return result;
});
